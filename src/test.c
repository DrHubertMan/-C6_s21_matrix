...
START_TEST(s21_sum_matrix__ok_1) {
#line 71
...
START_TEST(s21_sum_matrix__ok_2) {
#line 92
  matrix_t A, B, RES, REAL;
...
START_TEST(s21_sum_matrix__ok_3) {
#line 113
  matrix_t A, B, RES, REAL;
...
#line 133
  ...
  ck_assert_int_eq(s21_sum_matrix(&A, &B, &RES), BAD_CALCULATE);
  s21_remove_matrix(&A);
  s21_remove_matrix(&B);
}
END_TEST
...
START_TEST(s21_sub_matrix__ok_1) {
#line 166
  matrix_t A, B, RES, REAL;
  s21_create_matrix(10, 10, &A);
  s21_create_matrix(10, 10, &B);
...
START_TEST(s21_sub_matrix__ok_2) {
#line 187
  matrix_t A, B, RES, REAL;
  s21_create_matrix(10, 20, &A);
  s21_create_matrix(10, 20, &B);
...
START_TEST(s21_sub_matrix__ok_3) {
#line 208
  matrix_t A, B, RES, REAL;
  s21_create_matrix(10, 1, &A);
  s21_create_matrix(10, 1, &B);
...
#line 228
  ...
  s21_create_matrix(10, 1, &A);
  s21_create_matrix(10, 2, &B);
  ck_assert_int_eq(s21_sub_matrix(&A, &B, &RES), BAD_CALCULATE);
  s21_remove_matrix(&A);
  s21_remove_matrix(&B);
}
END_TEST
...
START_TEST(s21_mult_number__ok_1) {
#line 262
  matrix_t A, RES, REAL;
  s21_create_matrix(10, 10, &A);
  s21_create_matrix(10, 10, &REAL);
...
START_TEST(s21_mult_number__ok_2) {
#line 262
  matrix_t A, RES, REAL;
  s21_create_matrix(10, 10, &A);
  s21_create_matrix(10, 10, &REAL);
...
START_TEST(s21_mult_matrix__ok_1) {
#line 282
  matrix_t A, B, RES, REAL;
...
START_TEST(s21_transpose__ok_1) {
#line 314
  matrix_t A, RES, REAL;
...
START_TEST(s21_calc_complements__ok10) {
#line 333
...
START_TEST(s21_calc_complements__ok70) {
#line 346
  matrix_t A = {0}, B = {0}, C = {0};
...
START_TEST(s21_calc_complements__ok0) {
#line 365
  matrix_t A = {0}, B = {0}, C = {0};
  s21_create_matrix(2, 2, &A);
  s21_create_matrix(2, 2, &C);
...
START_TEST(s21_calc_complements__ok1) {
#line 384
  matrix_t A = {0}, B = {0}, C = {0};
...
#line 420
  ...
  ck_assert_int_eq(s21_calc_complements(&a, &b), BAD_CALCULATE);
  s21_remove_matrix(&a);
  s21_remove_matrix(&b);
}
END_TEST

START_TEST(s21_calc_complements__ok_2) {
#line 428
  const int size = 3;
  matrix_t m = {0};
...
START_TEST(s21_calc_complements__ok_3) {
#line 460
  matrix_t a = {0};
  matrix_t b = {0};
  s21_create_matrix(1, 2, &a);
...
START_TEST(s21_inverse_matrix__ok1) {
#line 469
  matrix_t A = {0}, B = {0}, C = {0};
  s21_create_matrix(3, 3, &A);
  s21_create_matrix(3, 3, &C);
...
START_TEST(s21_inverse_matrix__ok2) {
#line 498
  matrix_t A = {0}, C = {0};
  s21_create_matrix(3, 3, &A);
  s21_create_matrix(3, 3, &C);
...
START_TEST(s21_inverse_matrix__ok3) {
#line 528
  matrix_t m = {0};
  matrix_t result = {0};
...
START_TEST(s21_determinant__ok1) {
#line 543
  const int size = 5;
  matrix_t m = {0};
  s21_create_matrix(size, size, &m);
...
START_TEST(s21_determinant__ok2) {
#line 557
  const int size = 4;
  matrix_t m = {0};
  s21_create_matrix(size, size, &m);
...
START_TEST(s21_determinant__ok3) {
#line 573
  const int size = 5;
  matrix_t m = {0};
  s21_create_matrix(size, size, &m);
...
int main(void) {
  ...
  tcase_add_loop_test(tc1_1, create_matrix__ok, 0, 10);
  ...
  tcase_add_test(tc1_2, s21_eq_matrix__ok);
  suite_add_tcase(s1, tc1_3);
  tcase_add_test(tc1_3, s21_sum_matrix__ok_1);
  tcase_add_test(tc1_3, s21_sum_matrix__ok_2);
  tcase_add_test(tc1_3, s21_sum_matrix__ok_3);
  ...
  tcase_add_test(tc1_4, s21_sub_matrix__ok_1);
  tcase_add_test(tc1_4, s21_sub_matrix__ok_2);
  tcase_add_test(tc1_4, s21_sub_matrix__ok_3);
  ...
  tcase_add_loop_test(tc1_5, s21_mult_number__ok_1, 0, 10);
  tcase_add_loop_test(tc1_5, s21_mult_number__ok_2, 0, 10);
  suite_add_tcase(s1, tc1_6);
  tcase_add_loop_test(tc1_6, s21_mult_matrix__ok_1, 0, 10);
  suite_add_tcase(s1, tc1_7);
  tcase_add_loop_test(tc1_7, s21_transpose__ok_1, 0, 10);
  suite_add_tcase(s1, tc1_8);
  tcase_add_test(tc1_8, s21_calc_complements__ok10);
  tcase_add_test(tc1_8, s21_calc_complements__ok70);
  tcase_add_test(tc1_8, s21_calc_complements__ok0);
  tcase_add_test(tc1_8, s21_calc_complements__ok1);
  tcase_add_test(tc1_8, s21_calc_complements__err_1);
  tcase_add_test(tc1_8, s21_calc_complements__err_2);
  tcase_add_test(tc1_8, s21_calc_complements__ok_2);
  tcase_add_test(tc1_8, s21_calc_complements__ok_3);
  tcase_add_test(tc1_8, s21_inverse_matrix__ok1);
  tcase_add_test(tc1_8, s21_inverse_matrix__ok2);
  tcase_add_test(tc1_8, s21_inverse_matrix__ok3);
  suite_add_tcase(s1, tc1_9);
  tcase_add_test(tc1_9, s21_determinant__ok1);
  tcase_add_test(tc1_9, s21_determinant__ok2);
  tcase_add_test(tc1_9, s21_determinant__ok3);
